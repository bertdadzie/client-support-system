            ...
            <div class="login-box card">
                <div class="card-body">
                    <?php 
                            ...
                            switch ($error) {
                                case 0:
                                   $message = "<div class='alert alert-info' role='alert'><p>Please Enter User Name And Password</p></div>";
                                    break;
                                case 1:
                                   $message = "<div class='alert alert-danger' role='alert'>You Need TO Login Before You Can Get Access To That Page</div>";
                                    break;
                                case 2:
                                   $message = "<p class='alert alert-info' role='alert'>You Have Succesfully Logout</p>";
                                    break;
                            }
                            echo $message;
                            ?>

                    <form class="form-horizontal form-material" id="loginform" action="loginAction.php" method="post">
