...
<div id="listData" class="list-form-container">
    <?php
        ...
        $connection = imap_open('{imap.gmail.com:993/imap/ssl/novalidate-cert}INBOX', 'charityakosuadankwah@gmail.com', '2017Jgold') or die('Cannot connect to Gmail: ' . imap_last_error());
